...
export const getTestimonial = async (req: Request, res: Response) => {
  try {
    ...
    res.status(500).json({ message: 'Erreur lors de la récupération du témoignage', error });
  }
};
...
export const createTestimonial = async (req: Request, res: Response) => {
  try {
    ...
    res.status(400).json({ message: 'Erreur lors de la création du témoignage', error });
  }
};
...
export const updateTestimonial = async (req: Request, res: Response) => {
  try {
    ...
    res.status(400).json({ message: 'Erreur lors de la mise à jour du témoignage', error });
  }
};
