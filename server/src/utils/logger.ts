...
class Logger {
    ...
    private constructor() {
        ...
        this.config = {
            ...
            maxFileSizeInBytes: Number(process.env.MAX_LOG_FILE_SIZE) || 5 * 1024 * 1024 // 5MB
        };
    ...
    private initializeLogger(): void {
        ...
        this.rotateLogFiles();
        this.currentLogFile = path.join(this.config.logDirectory, `app-${this.getTimestamp()}.log`);
    ...
    private formatMessage(level: LogLevel, message: string, additionalContext?: any): string {
