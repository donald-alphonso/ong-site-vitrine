    ...
    <div className='min-h-screen flex justify-center items-center bg-gray-100'>
      <div className='bg-white space-y-8 p-8 shadow-lg rounded-lg max-w-md mx-auto w-full'>
        ...
        <form onSubmit={handleLogin} className='mt-8 space-y-6'>
          ...
          <button type="submit" className='w-full bg-red-500 border border-transparent shadow-sm text-sm font-medium text-white px-6 py-3 rounded-md hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500'>Login</button>
        </form>
      </div>
    </div>
  );
